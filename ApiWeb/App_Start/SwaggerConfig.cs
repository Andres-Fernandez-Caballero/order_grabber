                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ApiWeb")
                            .Description("API web para la comunicacion con la plataforma Order Grabber")
                            .Contact(cc => cc
                                .Name("Andres Fernandez")
                                .Email("andres.fernandezcaballero@davinci.edu.ar")
                                .Url("https://github.com/Andres-Fernandez-Caballero/order_grabber.git")
                            );
